...
class DatasetPartitioner(ABC):
    ...
    def generate_paired_subsets(
        self, train_dataset: Union[Dataset, datasets.Dataset], test_dataset: Union[Dataset, datasets.Dataset]
    ...
    def generate_client_datasets(
        self, train_dataset: Union[Dataset, datasets.Dataset], test_dataset: Union[Dataset, datasets.Dataset], **kwargs
    ) -> List[ClientDataset]:
